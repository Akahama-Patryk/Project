...
$dataCategory = new Product();
$result = $dataCategory->FetchCategory();
?>
<html lang="nl">
<head>
                ...
                <main class="px-3 mt-3">
                    <div class='col-md-12'>
                        <table class='table'>
                            ...
                            <tr>
                                <th scope='col'>Category Letter</th>
                    ...
                    <a href="dashboard_admin_category_add"
                       class="btn btn-primary align-items-md-end float-right"><i
