...
if (isset($_POST['submit'])) {
    ...
    $addCategory->addCategory($category_id,$category_name);

}
?>
<html lang="nl">
<head>
    <title>Project Supermarkt --Dashboard Admin:Category--</title>
    <meta charset="utf-8">
                        ...
                        <div class="card-body">
                            <form class="form" role="form" method="POST">
                                <div class="form-group">
                                    <label for="category_id">Category Letter</label>
                                    <input type="text" class="form-control form-control-lg rounded-0" name="category_id"
                                           id="category_id"
                                           placeholder="Type new Category letter." required>
                                    <div class="invalid-feedback">Oops, you missed this one.</div>
                                </div>
                                <div class="form-group">
                                    <label>Category Name</label>
                                    <input type="text" class="form-control form-control-lg rounded-0" id="category_name"
                                           name="category_name"
                                           placeholder="Type new Category name." required>
                                    <div class="invalid-feedback">Oops, you missed this one.</div>
                                </div>
                                <button type="submit" name="submit" class="btn btn-success btn-lg float-right"
                                        id="btnLogin">Add Category
                                </button>
                            </form>
                        </div>
                    </div>
