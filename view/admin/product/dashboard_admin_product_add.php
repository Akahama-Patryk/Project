                        ...
                        <div class="card-body">
                            <form class="form" role="form" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class='btn-sm' type='number' name='p_quantity' value="quantity" min="1"
                                           required>
                                </div>
                                <div class="form-group">
                                    <label for="product_price">Product Price</label>
                                    <input class='btn-sm' type='number' name='p_price' value="price" in="0.00"
                                ...
                                <button type="submit" name="submit" class="btn btn-success btn-lg float-right">Add
                                    product
                                </button>
                            </form>
                        </div>
